...
const WeightGoals = () => {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      const [{ data }, { data: profile }] = await Promise.all([
        supabase.from("onboarding_data").select("weight_kg, goal_weight, weight_unit").eq("user_id", user.id).single(),
  ...
  const steaks = Math.round(saved * 0.454 / 0.45); // ~0.45kg per steak
    ...
    >
      ...
      <motion.div className="space-y-12" variants={stagger} initial="hidden" animate="show">
        ...
        <motion.div variants={fadeUp} className="flex justify-end">
          <button
            onClick={switchUnit}
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-surface-container-high text-sm font-mono active:scale-[0.96] transition-transform"
          >
              ...
              <div className="relative rounded-2xl overflow-hidden">
                ...
                <div className="m-[2px] rounded-[14px] bg-surface-container-low p-6 md:p-8 relative">
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="font-headline font-bold text-lg text-on-surface tracking-tight uppercase">
                      Your Muscle Loss Projection
                    </h2>
                  </div>
                  ...
                  <div className="mb-6 pb-6 border-b border-outline-variant/15">
                    ...
                    <p className="font-mono text-3xl font-bold text-on-surface mt-1">
                      {animLoss} <span className="text-base text-on-surface-variant">{unit}</span>
                    </p>
                  </div>
                  ...
                  <div className="mb-6 pb-6 border-b border-outline-variant/15">
                    ...
                    <p className="text-on-surface-variant text-xs mt-1 font-mono">
                      = {withoutMLkg} kg of lean mass at risk
                    </p>
                  </div>

                  {/* WITH MuscleLock — green glow */}
                  ...
                  <div className="mt-5 text-center">
                    ...
                    <button
                      ...
                      className="text-xs text-secondary underline underline-offset-2 hover:text-primary transition-colors"
                    >
              ...
              <div className="space-y-5">
                <div className="p-4 rounded-xl bg-surface-container-high">
                  ...
                  <p className="text-xs text-on-surface-variant leading-relaxed">
                    ...
                    <em className="text-secondary"> New England Journal of Medicine</em>, 2021; 384:989-1002.
                  </p>
                  <p className="text-xs text-on-surface-variant mt-2">
                    Finding: ~40% of weight lost was lean body mass in the semaglutide group without structured resistance training.
                  </p>
                </div>
                <div className="p-4 rounded-xl bg-surface-container-high">
                  <p className="text-sm font-medium text-on-surface mb-1">Resistance Training + GLP-1</p>
                  <p className="text-xs text-on-surface-variant leading-relaxed">
                    Lundgren JR, et al. "Healthy Weight Loss Maintenance with Exercise, Liraglutide, or Both Combined."
                    <em className="text-secondary"> New England Journal of Medicine</em>, 2021; 384:1719-1730.
                  </p>
                  <p className="text-xs text-on-surface-variant mt-2">
                    Finding: Structured resistance exercise reduced lean mass loss to ~8% of total weight lost.
                  </p>
                </div>
                <div className="p-4 rounded-xl bg-surface-container-high">
                  ...
                  <p className="text-xs text-on-surface-variant leading-relaxed">
                    ...
                    <em className="text-secondary"> New England Journal of Medicine</em>, 2022; 387:205-216.
                  </p>
                  <p className="text-xs text-on-surface-variant mt-2">
                    Finding: Tirzepatide produced 23% greater weight loss vs semaglutide, with proportional lean mass loss.
                  </p>
                </div>
              </div>
            </motion.div>
